        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ InstallerHelper::isActive('LaravelInstaller::final') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ InstallerHelper::isActive('LaravelInstaller::environment')}} {{ InstallerHelper::isActive('LaravelInstaller::environmentWizard')}} {{ InstallerHelper::isActive('LaravelInstaller::environmentClassic')}}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ InstallerHelper::isActive('LaravelInstaller::permissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ InstallerHelper::isActive('LaravelInstaller::requirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ InstallerHelper::isActive('LaravelInstaller::welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
